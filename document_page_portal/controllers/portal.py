...
class CustomerPortal(CustomerPortal):
    ...
    @http.route(
        ['/my/document_pages', '/my/document_pages/page/<int:page>'],
    ...
    @http.route([
        "/knowledge/document_page/<int:document_page_id>",
        "/knowledge/document_page/<int:document_page_id>/<token>",
        '/my/document_page/<int:document_page_id>'
